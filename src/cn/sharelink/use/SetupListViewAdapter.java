...
public class SetupListViewAdapter extends BaseAdapter {
	...
	public SetupListViewAdapter(Context context, int language,
		...
		SetupItem item = new SetupItem(
				AppUtil.text_dialog_setting_content0[0][language], null, null,
				-1);
		arrayList.add(item);

		for (int i = 0; i < AppUtil.text_dialog_setting_content1.length; i++) {

			String name = AppUtil.text_dialog_setting_content1[i][0][language];
			String setup0 = AppUtil.text_dialog_setting_content1[i][1][language];
			String setup1 = AppUtil.text_dialog_setting_content1[i][2][language];
