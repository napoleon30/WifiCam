...
import cn.sharelink.fragment.Fragment4;
import cn.sharelink.fragment.Fragment44;
import cn.sharelink.fragment.Fragment5;
import cn.sharelink.fragment.Fragment55;
...
public class HelpAcitivity extends FragmentActivity implements OnClickListener,OnPageChangeListener {
	...
	private void judgeLanguage() {
		...
		if (curLocale.equals(Locale.US)) {
			...
			fragments.add(new Fragment44());
			fragments.add(new Fragment55());
		} else {
			// 中文背景图片
